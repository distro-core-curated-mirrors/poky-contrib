...
#   $ TASK_EXP_UNIT_TEST=1 bitbake -g -u taskexp_ncurses.py zlib acl
#   ...
#   $ echo $?
#   0
#   $ TASK_EXP_UNIT_TEST=1 bitbake -g -u taskexp_ncurses.py zlib acl foo
...
#   $ TASK_EXP_UNIT_TEST_NOTERM=1 bitbake -g -u taskexp_ncurses.py_2 quilt
#   $ echo $?
#   0
#
# Features:
