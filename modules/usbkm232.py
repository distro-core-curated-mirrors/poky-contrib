...
class UsbKm232():
    ...
    def __init__(self, km232_serial_device):
        '''
        ...
        if self.serial_device:
            ...
            while tries > 0:
                try:
                    self.serial = serial.Serial(self.serial_device, baudrate=9600)
    ...
    def send_list_of_commands(self, mylist, check=False, BUFFER_CLEAR=True):
        ...
        for i, write_ch in enumerate(mylist):
            print "UsbKm232: writing  [%d] = \\0%03o 0x%02x" % (i, ord(write_ch), ord(write_ch))
