...
# but the user may se it on their own conf
...
SRC_URI += "file://create_manifest.py file://get_module_deps.py file://python2-manifest.json"

do_create_manifest() {

cd ${WORKDIR}
# This needs to be executed by python-native and NOT by HOST's python
nativepython create_manifest.py
