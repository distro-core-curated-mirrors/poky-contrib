...
python native_virtclass_handler () {
    ...
    for pkg in re.split(r"\${@(?:{.*?}|.)+?}|\s", d.getVar("PACKAGES", False)):
        if not pkg:
            continue
        d.setVarFlag("RDEPENDS:" + pkg, "filter", "oe.classextend.native_filter(val, '" + pn + "', '" + bpn + "')")
        d.setVarFlag("RRECOMMENDS:" + pkg, "filter", "oe.classextend.native_filter(val, '" + pn + "', '" + bpn + "')")
        d.setVarFlag("RSUGGESTS:" + pkg, "filter", "oe.classextend.native_filter(val, '" + pn + "', '" + bpn + "')")
        d.setVarFlag("RPROVIDES:" + pkg, "filter", "oe.classextend.native_filter(val, '" + pn + "', '" + bpn + "')")
        d.setVarFlag("RREPLACES:" + pkg, "filter", "oe.classextend.native_filter(val, '" + pn + "', '" + bpn + "')")
