...
#addtask do_update_modules after do_patch
#do_update_modules[depends] = "go-native:do_populate_sysroot"
#do_update_modules[depends] = "virtual/${TUNE_PKGARCH}-go:do_populate_sysroot"
