                ...
                for l in f:
                    ...
                    if l.endswith("/"):
                        if native:
                            ...
                            dest = staging_copydir(l, recipesysroot, stagingdir)
                        continue
                    if native:
                        dest = staging_copyfile(l, recipesysrootnative, fixmenative, postinsts, stagingdir)
                    else:
                        dest = staging_copyfile(l, recipesysroot, fixme, postinsts, stagingdir)
                    if dest:
                        m.write(dest + "\n")
