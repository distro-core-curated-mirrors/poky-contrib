...
do_install () {
    ...
    nativepython3 -m pip install -vvvv --no-index --target ${D}${PYTHON_SITEPACKAGES_DIR} --find-links=${STAGING_LIBDIR}/${PYTHON_DIR}/site-packages ./dist/${FLIT_CORE_PACKAGE}-${PV}-*.whl
}
