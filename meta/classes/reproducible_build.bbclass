...
SSTATETASKS += "do_create_src_date_epoch_stamp"
do_create_src_date_epoch_stamp[sstate-plaindirs] = "${SDE_DIR}"

python do_create_src_date_epoch_stamp_setscene () {
    sstate_setscene(d)
}
addtask do_create_src_date_epoch_stamp_setscene
