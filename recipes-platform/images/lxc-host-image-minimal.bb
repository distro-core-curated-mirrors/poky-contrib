...
install_container_images() {
    for c in ${CONTAINER_IMAGES}; do
        ...
        src="${TOPDIR}/tmp-${config}/deploy/images/${MACHINE}/${image}-${MACHINE}${MACHINE_SUFFIX}.rootfs.tar.bz2"
...
IMAGE_ROOTFS_EXTRA_SPACE:append = "${@bb.utils.contains("DISTRO_FEATURES", "systemd", " + 409600", "" ,d)}"
