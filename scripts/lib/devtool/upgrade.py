...
def upgrade(args, config, basepath, workspace):
    ...
    try:
        ...
        try:
            ...
            if extradirs and not oe.path.is_path_parent(current_ret.srcsubdir, *extradirs.keys()):
            ...
            rf, copied = _create_new_recipe(args.version, md5, sha256, args.srcrev, srcbranch, current_ret.srcsubdir, srcsubdir2, config.workspace_path, tinfoil, rd, license_diff, new_licenses)
